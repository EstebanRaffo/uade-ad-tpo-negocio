...
public class Controlador {
	...
	/*Método específico para obtener todos los pedidos en la base de datos de un cliente. Modificación*/
	public List<PedidoView> getPedidoByCliente(int numeroCliente) throws PedidoException{
		List<PedidoView> resultado = new ArrayList<PedidoView>();
		List<Pedido> pedidos = PedidoDAO.getInstancia().findPedidoByCliente(new Cliente(numeroCliente, null, null, "true"));
		for(Pedido p : pedidos)
			resultado.add(p.toView());
		return resultado;
	}
	/*Método específico para obtener todos los pedidos en la base de datos con un estado particular. Modificacion*/
	public List<PedidoView> getPedidoByEstado(String estado) throws PedidoException{
		List<PedidoView> resultado = new ArrayList<PedidoView>();
		List<Pedido> pedidos = PedidoDAO.getInstancia().findPedidoByEstado(estado);
		for(Pedido p : pedidos)
			resultado.add(p.toView());
		return resultado;
	}
	/*Método específico para obtener todos los pedidos en la base de datos.*/
	public List<PedidoView> getPedidos() throws PedidoException{
		List<PedidoView> resultado = new ArrayList<PedidoView>();
